        ...
        <div class="col-md-8">
            <div class="card">
                ...
                @endif
                    ...
                    <div class="card-body">
                        <video-js id="video" class="video-js" controls preload="auto" width="640" height="268">
                        ...
                        <div>
                            @if ($video->editable())
                                <textarea class="form-control" name="description" cols="3" rows="3">{{ $video->description }}</textarea>
